...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a class="J_menuItem" href="index/own/formavatar">修改信息</a>
                            </li>
                            <li><a class="J_menuItem" href="index/own/profile">个人资料</a>
                            </li>
                            </li>
                            <li class="divider"></li>
                            <li><a href="index/own/login">安全退出</a>
                            </li>
                        </ul>
                    </div>
                ...
                <li>
                    <a href="#">
                        ...
                        <span class="nav-label">公众号</span>
                        <span class="fa arrow"></span>
                    </a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="index/wechat/account" data-index="0">公众号管理</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="index/wechat/reply">回复管理</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="index/wechat/menu">菜单管理</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="index/wechat/qrcodeasq">二维码管理</a>
                        </li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="home/index" frameborder="0" data-id="home" seamless></iframe>
        </div>
        <div class="footer">
